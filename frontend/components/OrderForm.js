...
function orderShipmentForm({ onClickSubmit }) {
	...
	return (
		<>
			...
			<form className="font-semibold text-gray-500" onSubmit={handleSubmit(onSubmit)}>
				<div className="m-8 p-2">
					Pickup Address
					<div className="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8 mt-5 mx-7">
						<div className="grid grid-cols-1">
							<label className="uppercase md:text-sm text-xs text-light">City</label>
							<input
						...
						<div className="grid grid-cols-1">
							<label className="uppercase md:text-sm text-xs text-light">ZIP Code</label>
							<input
								className="py-2 px-3 rounded-lg border-2 border-purple-300 mt-1 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent"
								type="text"
								name="pickupZipCode"
					...
					<div className="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8 mt-5 mx-7">
						<div className="grid grid-cols-1">
							<label className="uppercase md:text-sm text-xs text-light">Street</label>
							<input
								className="py-2 px-3 rounded-lg border-2 border-purple-300 mt-1 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent"
								type="text"
								name="pickupStreet"
					...
					<div className="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8 mt-5 mx-7">
						<div className="grid grid-cols-1">
							...
							<input
								...
								onChange={(e) => {
									setPrice(
										(parseFloat(e.target.value) + parseFloat(servicesPrice)).toFixed(2)
									);
						...
						<div className="grid grid-cols-1">
							<label className="uppercase md:text-sm text-xs text-light">Services</label>
											...
											<input
												...
												onChange={(e) => {
													if (e.target.checked) {
														...
														setServicesPrice(
															(parseFloat(servicesPrice) + service.price).toFixed(2)
														);
