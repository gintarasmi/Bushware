	...
	return (
		<>
			...
			<table className={styles.deliveryStatusTable}>
				<thead>
					<tr>
						<th className={styles.tableTitle}>Shipments to pickup</th>
						<th colSpan="2">
							<button
					...
					<tr>
						<td className={styles.addressTitle}>Address</td>
				...
				<tbody id="ShipmentsInProgress">
					{items_pickup.map((item) => (
						<tr>
							...
							<td className={styles.deliveryDateCol}>{item.estDeliveryDate}</td>
			...
			<table className={styles.deliveryStatusTable}>
				<thead>
					<tr>
						<th className={styles.tableTitle}>Shipments in progress</th>
					</tr>
					<tr>
						<td className={styles.addressTitle}>Address</td>
			...
			<table className={styles.deliveryStatusTable}>
				<thead>
					<tr>
						<th className={styles.tableTitle}>Past shipments</th>
					</tr>
					<tr>
						<td className={styles.addressTitle}>Address</td>
						<td className={styles.deliveryDateTitle}>Estimated delivery date</td>
